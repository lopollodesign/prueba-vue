  ...
  <div class="carrito">
    ...
    <div id="lista-cursos" class="container">
      ...
      <div class="row">
        <div class="four columns">
          <div class="card">
            <img src="../assets/curso1.jpg" class="imagen-curso u-full-width">
            <div class="info-card">
        ...
        <div class="four columns">
          <div class="card">
            <img src="../assets/curso2.jpg" class="imagen-curso u-full-width">
            <div class="info-card">
        ...
        <div class="four columns">
          <div class="card">
            <img src="../assets/curso3.jpg" class="imagen-curso u-full-width">
            <div class="info-card">
      ...
      <div class="row">
        <div class="four columns">
          <div class="card">
            <img src="../assets/curso4.jpg" class="imagen-curso u-full-width">
            <div class="info-card">
        ...
        <div class="four columns">
          <div class="card">
            <img src="../assets/curso5.jpg" class="imagen-curso u-full-width">
            <div class="info-card">
        ...
        <div class="four columns">
          <div class="card">
            ...
            <div class="info-card">
              ...
              <img src="../assets/estrellas.png">
              <p class="precio">$200 <span class="u-pull-right ">$15</span></p>
              <a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="9">Agregar Al
                Carrito</a>
            </div>
          </div> <!--.card-->
        </div>
